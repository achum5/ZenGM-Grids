          ...
          <div className="max-h-64 overflow-y-auto space-y-2">
            ...
            {players.map((player) => (
              <Button
                key={player.id}
                variant="ghost"
                className="w-full text-left p-3 h-auto justify-start bg-slate-700 hover:bg-slate-600 transition-all duration-200 rounded-lg border border-slate-600 hover:border-slate-500"
