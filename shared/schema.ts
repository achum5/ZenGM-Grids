...
export const gameSessions = pgTable("game_sessions", {
  ...
  answers: jsonb("answers").$type<{ [key: string]: { player: string; correct: boolean; quality?: number; rarity?: number; rarityRank?: number; careerWS?: number; eligibleCount?: number } }>().notNull().default({}),
